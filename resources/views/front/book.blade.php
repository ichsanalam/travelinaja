        ...
        <form action="{{ route('front.book.store', $packageTour->slug) }}" method="POST" class="flex flex-col gap-8">
          ...
          <div class="flex flex-col gap-3 px-4 ">
            ...
            <div class="flex items-center gap-[10px] bg-white p-[16px_24px] rounded-[37px]  transition-all duration-300">
              <input type="date" required name="start_date" id="start_date" class="appearance-none outline-none w-full relative text-sm tracking-035 leading-[22px] [&::-webkit-calendar-picker-indicator]:absolute [&::-webkit-calendar-picker-indicator]:w-full [&::-webkit-calendar-picker-indicator]:h-full [&::-webkit-calendar-picker-indicator]:opacity-0">
