            ...
            <div class="p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action=" {{ route('admin.package_tours.update', $packageTour) }} "
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5" class="w-full border border-slate-300 rounded-xl">{{ $packageTour->about }}
                        </textarea>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="photo" class="block w-full mt-1" type="file" name="photos[]" autofocus
                            autocomplete="photo" />
