                ...
                <form method="POST" action=" {{ route('admin.package_banks.update', $packageBank) }} " enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="bank_account_name" class="block mt-1 w-full" type="text"
                            name="bank_account_name" value=" {{ $packageBank->bank_account_name }} " required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="bank_account_number" class="block mt-1 w-full" type="number"
                            name="bank_account_number" value=" {{ $packageBank->bank_account_number }} " required autofocus autocomplete="name" />
